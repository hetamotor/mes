...
public class HrmServiceImpl implements HrmService {
    ...
    public List<Dept> findAllDept() {
        return partDao.selectAllDept();
    }

    /** HrmServiceImpl接口findDept方法实现 */
    @Transactional(readOnly = true)
    @Override
    public List<TestResult> findDept(Dept dept, PageModel pageModel) {
        Map<String, Object> params = new HashMap<>(); // 当前需要分页的总数据条数
        ...
        List<TestResult> depts = partDao.selectByPage(params);
    ...
    @Override
    public TestResult findPartById(Integer id) {
    ...
    @Transactional(readOnly = true)
    @Override
    public List<Notice> findNotice(Notice notice, PageModel pageModel, String starttime, String endtime) {
        Map<String, Object> params = new HashMap<>(); // 当前需要分页的总数据条数
