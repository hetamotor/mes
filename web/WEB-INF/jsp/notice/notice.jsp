...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：零件追溯 &gt; 投料查询</td>
                    ...
                    <td class="fftd">
                        <form name="noticeform" method="post" id="noticeform" action="${ctx}/notice/selectNotice">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                                        供应商批次：<input type="text" name="content">&nbsp;&nbsp;
                                        开始时间：<input cssClass="Wdate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'});"
                                                  name="starttime" id="starttime" size="30"/>&nbsp;&nbsp;
                                        结束时间：<input cssClass="Wdate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'});"
                                                    name="endtime" id="endtime" size="30"/>&nbsp;&nbsp;
                ...
                <c:forEach items="${requestScope.notices}" var="notice" varStatus="stat">
                    <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);"
                        ...
                        <td align="center" width="40px;">
                            ...
                            1 == sessionScope.user_session.userrole}">
                                <a href="${ctx }/notice/updateNotice?flag=1&id=${notice.id}">
